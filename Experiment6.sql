...
/* UNION */
SELECT WORKING_AREA FROM CUSTOMER
UNION
...
SELECT  CUST_CODE, CUST_NAME, PAYMENT_AMT, CUST_CITY
     FROM CUSTOMER
     LEFT JOIN PHONE_NO
     ON experimeny.CUSTOMER = experiment.agents
INTERSECT
     SELECT  CUST_CODE, CUST_NAME, PAYMENT_AMT, CUST_CITY
     FROM CUSTOMER
     RIGHT JOIN PHONE_NO
     ON experiment.CUSTOMER = experiment.agnets;